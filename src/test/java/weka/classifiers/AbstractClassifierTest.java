...
public abstract class AbstractClassifierTest extends TestCase {
    ...
    /**
     * wether classifier can predict nominal attributes (array index is
     * attribute type of class)
     */
    protected boolean[] m_NominalPredictors;

    /**
     * wether classifier can predict numeric attributes (array index is
     * attribute type of class)
     */
     ...
     * @return true if at least one attribute type can be predicted with the
     * given class
     */
     ...
     *
     * @see #checkAttributes(boolean, boolean, boolean, boolean, boolean,
     * boolean, boolean)
     */
     ...
     *
     * @see CheckClassifier#canHandleOnlyClass(boolean, boolean, boolean,
     * boolean, boolean, int)
     * @see CheckClassifier#testsPerClassType(int, boolean, boolean, boolean)
     */
     ...
     *
     * @see CheckClassifier#canHandleNClasses(boolean, boolean, boolean,
     ...
     * method
     *
     * @see CheckClassifier#correctBuildInitialisation(boolean, boolean,
     ...
     * object matches that in a reference version. When this test is run without
     * any pre-existing reference output, the reference version is created.
     */
