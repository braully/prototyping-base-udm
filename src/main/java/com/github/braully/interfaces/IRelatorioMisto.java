 ...
 * @author braullyrocha
 */
public interface IRelatorioMisto {

    public byte[] gerarRelatorioByte(ReportTemplate relatorio, Map paramSimples);

    public byte[] gerarRelatorioByte(ReportTemplate relatorio, Map paramBean, Collection colecao);
