 ...
 *
 */
//https://github.com/GowthamGirithar/playground-2owplW8D/blob/master/java-project/src/main/java/com/gg/ml/NaiveBayesDemo.java
//https://www.codingame.com/playgrounds/6734/machine-learning-with-java---part-5-naive-bayes
//https://docs.deistercloud.com/Technology.50/Machine%20Learning/index.xml?embedded=true&navbar=0&param-iframe=index-iframe
//https://www.codingame.com/playgrounds/6734/machine-learning-with-java---part-5-naive-bayes
...
public class NaiveBayesDemo {
    ...
    public static Instances getDataSet(String fileName) throws Exception {
         ...
         */
        loader.setSource(UtilIO.loadStreamFromFilePath("datasets/" + fileName));
        /**
