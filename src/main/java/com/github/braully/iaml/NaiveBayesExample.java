...
public class NaiveBayesExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        trainingFiles.put("English", UtilPath.getUrl("datasets/training.language.en.txt"));
        trainingFiles.put("French", UtilPath.getUrl("datasets/training.language.fr.txt"));
        trainingFiles.put("German", UtilPath.getUrl("datasets/training.language.de.txt"));
