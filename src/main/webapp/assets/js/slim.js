...
$(function () {
    ...
    var tabidx = window.sessionStorage.getItem('tab');
    if(tabidx){
        tabview = $('div.autogen-tabview');
        if(window.sessionStorage.getItem('tabid') == tabview.attr('id')) {
            //console.log('Loaded tab id');
            //console.log(tabview);
            var widget = PF('tabView');
            //console.log('widget');
            //console.log(widget);
            widget.select(tabidx);
        }
        //else {
        //  console.log('Diferent id');
        //}
    } 
    //else {
    //  console.log('No tab id'); 
    //}
    //console.log($('div.autogen-tabview'));
});
} catch(e) {
    console.error(e);
}
